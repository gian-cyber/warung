...
<head>
  ...
  <title>APLIKASI PEMESANAN MENU MAKANAN | RUMAH MAKAN PINGGIR SAWAH</title>
...
<body class="hold-transition skin-red-light layout-boxed layout-top-nav ">
  <div class="wrapper">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a href="/">RUMAH MAKAN PINGGIR SAWAH <span class="sr-only">(current)</span></a></li>
              <!-- <li><a href="#">Link</a></li> -->
              <?php
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2020 <a href="#">RUMAH MAKAN PINGGIR SAWAH</a>. | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
      </strong>
    </footer>
